    ...
    <Modal variant="custom" className="p-6 overflow-hidden" isActive={isActive} onCancel={() => closeModal(false)}>
      ...
      <div className="text-center">
        ...
        <form onSubmit={handleSubmit} className="relative">
          ...
          <h3 className="text-slate-50 font-semibold mt-6">Subscribe to GPTFinder</h3>
          <p className="text-slate-300 mt-2">Get weekly email with best new GPTs and AI tools</p>
          {!isSubscribingDone ? (
            <Input
              required
              autoFocus
